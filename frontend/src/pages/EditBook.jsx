    ...
    return (
        <div className="p-4 ">
            ...
            <div className="flex flex-col border-2 border-sky-400 rounded-x1 w-[660px] py-4 mx-auto">
                ...
                <div className="m-4">
                    <label className="text x-l mr-4 text-gray-500">Author</label>
                    <input
                    type="text"
                    value={author}
                ...
                <div className="m-4">
                    <label className="text x-l mr-4 text-gray-500">Publish Year</label>
                    <input
                    type="text"
                    value={publishYear}
                ...
                <button className="p-1 bg-sky-300 m-8" onClick={handleEditBook}>
                    Save
                </button>
            </div>
        </div>
